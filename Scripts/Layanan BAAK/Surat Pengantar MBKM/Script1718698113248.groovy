...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Surat MBKM'))

WebUI.click(findTestObject('Object Repository/Page_Surat Rekomendasi MBKM/a_Ajukan Surat'))

WebUI.setText(findTestObject('Object Repository/Page_Ajukan Surat Rekomendasi MBKM/input_Angkatan MBKM_SuratRekomendasiMbkmang_0fea94'), 
    '2022')

WebUI.setText(findTestObject('Object Repository/Page_Ajukan Surat Rekomendasi MBKM/input_Tahun MBKM_SuratRekomendasiMbkmtahun_mbkm'), 
    '2024')
