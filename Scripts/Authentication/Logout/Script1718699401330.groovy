...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Johanna  Romauli Siagian'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Sign out'))
